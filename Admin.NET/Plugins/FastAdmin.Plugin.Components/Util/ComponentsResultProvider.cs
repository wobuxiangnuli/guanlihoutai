namespace FastAdmin.Plugin.Components.Util;

/// <summary>
/// Components 规范化结果
/// </summary>
[UnifyModel(typeof(ComponentsResult<>))]
public class ComponentsResultProvider : IUnifyResultProvider
{
    /// <summary>
    /// 异常返回值
    /// </summary>
    ...
    /// <returns></returns>
    private static ComponentsResult<object> RESTfulResult(int statusCode, bool succeeded = default, object data = default, object errors = default)
    {
        return new ComponentsResult<object>
        {
            Code = statusCode,
...
public class ComponentsResult<T>
{
    /// <summary>
    /// 状态码
    /// </summary>
