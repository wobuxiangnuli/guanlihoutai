...
/// DataSet 规范化结果
/// </summary>
[UnifyModel(typeof(DataSetResult<>))]
public class DataSetResultProvider : IUnifyResultProvider
{
    /// <summary>
    /// 异常返回值
    /// </summary>
    ...
    /// <returns></returns>
    private static DataSetResult<object> RESTfulResult(int statusCode, bool succeeded = default, object data = default, object errors = default)
    {
        return new DataSetResult<object>
        {
            Code = statusCode,
