<template>
	<div class="sys-pos-container">
        ...
        <editDataSet ref="editPosRef" :title="state.editPosTitle" @handleQuery="handleQuery"/>
	</div>
</template>
...
const handleQuery = async () => {
	state.loading = true;
	var res = await getAPI(getAPI).apiSysPosListGet(state.queryParams.page, state.queryParams.limit);
